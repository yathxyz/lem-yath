...
Lisp generic-expression forms, and for native Org, Markdown, Python, and Java indices
...
mapping while omitting constructors and actual enum declarations. Native
indices for other non-LSP modes remain a provider gap.
